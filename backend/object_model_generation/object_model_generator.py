...
class ObjectModelGenerator:
    ...
    def save(self):
        process_config = ProcessConfig.load(self.sessionPath)
        otypes = process_config.otypes
        otypes = [otype for otype in otypes if otype in self.generatedModel.objectsByType.keys()]
        process_config.update_object_types(self.sessionPath, otypes)
